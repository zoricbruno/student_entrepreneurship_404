...
\begin{figure}[!h]
	\centering
	\includegraphics[width=0.4\textwidth]{HomeScreen}
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=0.4\textwidth]{InspiredScreen}
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=0.4\textwidth]{PlayScreen}
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=0.4\textwidth]{LaughScreen}
